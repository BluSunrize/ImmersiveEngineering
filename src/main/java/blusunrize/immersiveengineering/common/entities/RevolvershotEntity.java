...
public class RevolvershotEntity extends IEProjectileEntity
{
	public static final EntityType<RevolvershotEntity> TYPE = Builder
			.<RevolvershotEntity>of(RevolvershotEntity::new, MobCategory.MISC)
			.sized(0.125f, 0.125f)
	...
	public RevolvershotEntity(Level world)
	{
		this(TYPE, world);
	}
	...
	public RevolvershotEntity(Level world, LivingEntity living, double ax, double ay, double az, ResourceLocation type)
	{
