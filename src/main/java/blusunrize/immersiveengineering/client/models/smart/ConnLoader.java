...
public class ConnLoader implements ICustomModelLoader{
	...
	static {
		...
		textureReplacements.put("rel_hv", ImmutableMap.of("#immersiveengineering:blocks/connector_connectorHV", "immersiveengineering:blocks/connector_relayHV"));
	...
	public boolean accepts(ResourceLocation modelLocation) {
		return modelLocation.getResourceDomain().equalsIgnoreCase(ImmersiveEngineering.MODID.toLowerCase())&&modelLocation.getResourcePath().contains(RESOURCE_LOCATION);
	}
