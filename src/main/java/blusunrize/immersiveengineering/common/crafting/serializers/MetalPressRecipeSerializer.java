...
public class MetalPressRecipeSerializer extends IERecipeSerializer<MetalPressRecipe>
{
	...
	@Nullable
	@Override
	public MetalPressRecipe read(ResourceLocation recipeId, @Nonnull IEPacketBuffer buffer)
	{
	...
	@Override
	public void write(@Nonnull IEPacketBuffer buffer, MetalPressRecipe recipe)
	{
