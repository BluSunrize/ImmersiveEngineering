...
public class GoVoteHandler
{
	...
	private static class GoVoteScreen extends Screen
	{
		...
		public void render(MatrixStack mstack, int mx, int my, float pticks)
		{
			...
			ITextComponent note1 = s("Note: If you can't vote in the United States,").func_240699_a_(TextFormatting.ITALIC);
			ITextComponent note2 = s("Please press ESC and carry on.").func_240699_a_(TextFormatting.ITALIC);
