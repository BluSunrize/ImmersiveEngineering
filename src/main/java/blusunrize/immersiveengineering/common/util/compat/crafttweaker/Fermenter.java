...
public class Fermenter
{
	...
	{
		if (!Config.IEConfig.machines.fermenter_enabled) return;
	...
	{
		if (Config.IEConfig.machines.fermenter_enabled && CraftTweakerHelper.toFluidStack(fluid)!=null)
	...
	{
		if (Config.IEConfig.machines.fermenter_enabled && !CraftTweakerHelper.toStack(stack).isEmpty())
	...
	{
		if (Config.IEConfig.machines.fermenter_enabled && CraftTweakerHelper.toStack(stack)!=null)
