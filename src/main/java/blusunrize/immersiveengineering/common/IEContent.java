...
public class IEContent
{
	...
	public static void init()
	{
		...
		ThermoelectricHandler.registerSourceInKelvin(new ResourceLocation("forge:ices/dry"), 150);
		ThermoelectricHandler.registerSourceInKelvin(IETags.getTagsFor(EnumMetals.URANIUM).storage, 2000);
		ThermoelectricHandler.registerSourceInKelvin(new ResourceLocation("forge:storage_blocks/uraninite"), 2000);
