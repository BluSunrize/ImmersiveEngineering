...
public class FermenterRecipeCategory extends IERecipeCategory
{
	...
	{
		super("fermenter","tile.immersiveengineering.metalMultiblock.fermenter.name", helper.createDrawable(background, 6,12, 164,59), FermenterRecipeWrapper.class, new ItemStack(IEContent.blockMetalMultiblock,1,BlockTypes_MetalMultiblock.FERMENTER.getMeta()));
