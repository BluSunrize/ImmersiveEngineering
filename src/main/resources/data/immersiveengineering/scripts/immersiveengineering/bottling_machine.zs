 ...
 */
//<recipetype:immersiveengineering:bottling_machine>.addRecipe(recipePath as string, itemInput as IIngredient, fluidTag as MCTag<Fluid>, amount as int, output as IItemStack)
