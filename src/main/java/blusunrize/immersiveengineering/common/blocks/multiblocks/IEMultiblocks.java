...
public class IEMultiblocks
{
	...
	public static final IMultiblock ASSEMBLER = CRUSHER;
	public static final IMultiblock AUTO_WORKBENCH = CRUSHER;
	public static final IMultiblock BLAST_FURNACE = CRUSHER;
	public static final IMultiblock ADVANCED_BLAST_FURNACE = CRUSHER;
	public static final IMultiblock BOTTLING_MACHINE = CRUSHER;
	public static final IMultiblock BUCKET_WHEEL = CRUSHER;
	public static final IMultiblock COKE_OVEN = CRUSHER;
	public static final IMultiblock DIESEL_GENERATOR = CRUSHER;
	public static final IMultiblock EXCAVATOR = CRUSHER;
	...
	public static final IMultiblock METAL_PRESS = CRUSHER;
