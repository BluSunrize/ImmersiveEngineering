...
import blusunrize.immersiveengineering.common.blocks.metal.TileEntityConnector;
...
public class Config
{
	...
	private static void onConfigUpdate()
	{
		...
		TileEntityConnector.connectorInputValues = IEConfig.Machines.wireConnectorInput;
