...
public class Config
{
	...
	public static void preInit(FMLPreInitializationEvent event)
	{
		...
		setInt("hammerDurabiliy", config.get("general", "Hammer Durability", 250, "The maximum durability of the Engineer's Hammer. Used up when hammering ingots into plates.").getInt());
