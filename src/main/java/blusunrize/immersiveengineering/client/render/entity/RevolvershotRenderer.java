...
public class RevolvershotRenderer extends EntityRenderer<RevolvershotEntity>
{
						 ...
						 MultiBufferSource bufferIn, int packedLightIn)
	{
		...
		matrixStackIn.mulPose(new Quaternionf(0, entity.yRotO+(entity.getYRot()-entity.yRotO)*partialTicks-90.0F, 0, true));
		matrixStackIn.mulPose(new Quaternionf(0.0F, 0.0F, entity.xRotO+(entity.getXRot()-entity.xRotO)*partialTicks, true));
