...
public class PeripheralFermenter extends IEPeripheral
{
	...
	public PeripheralFermenter(World w, BlockPos pos)
	{
		super(w, pos);
	}
			...
			throws LuaException, InterruptedException
	{
		...
		case 0://recipe
			...
			FermenterRecipe recipe = FermenterRecipe.findRecipe(te.inventory[slot-1]);
			if (recipe!=null)
	...
	{
		TileEntityFermenter te = (TileEntityFermenter) w.getTileEntity(pos);
		if (te==null)
			return;
