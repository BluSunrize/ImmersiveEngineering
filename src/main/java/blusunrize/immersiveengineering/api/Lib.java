...
public class Lib
{
	...
	public static final int GUIID_Manual = 0;
	public static final int GUIID_CokeOven = 1;
	public static final int GUIID_BlastFurnace = 2;
	public static final int GUIID_WoodenCrate = 3;
	public static final int GUIID_Workbench = 4;
	public static final int GUIID_Assembler = 5;
	public static final int GUIID_Revolver = 6;
	public static final int GUIID_Toolbox = 7;
	public static final int GUIID_Sorter = 8;
	public static final int GUIID_Squeezer = 9;
	public static final int GUIID_Fermenter = 10;
	public static final int GUIID_Refinery = 11;
	public static final int GUIID_ArcFurnace = 12;
