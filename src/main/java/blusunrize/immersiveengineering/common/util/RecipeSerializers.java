...
public class RecipeSerializers
{
	...
	public static final RegistryObject<CompressedShapedRecipe.Serializer> COMPRESSED_SHAPED_SERIALIZER = RECIPE_SERIALIZERS.register(
			"compressed_shaped", CompressedShapedRecipe.Serializer::new
	);
