...
public class TileEntityFluidPipe extends TileEntityIEBase implements IEBlockInterfaces.IBlockOverlayText {
    ...
    for (PipeConnection connection : connections) {
      ...
      if (!traversed.contains(strCon)) {
        ...
        if (tileEntity instanceof TileEntityFluidPipe) {
          ((TileEntityFluidPipe) tileEntity).getAllTanks(traversed, tanksMap, depth + 1);
  ...
  public void invalidate() {
    ...
    for (PipeConnection connection : connections) {
      ...
      if (connectedTE instanceof TileEntityFluidPipe) {
        TileEntityFluidPipe fluidPipe = (TileEntityFluidPipe) connectedTE;
