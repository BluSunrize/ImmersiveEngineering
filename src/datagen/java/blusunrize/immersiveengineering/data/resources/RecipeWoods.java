...
public enum RecipeWoods
{
	...
	RecipeWoods(String name, boolean produceSawdust, ItemLike plank, ItemLike log, ItemLike stripped,
				ItemLike wood, ItemLike door, ItemLike stairs, ItemLike slab)
	{
