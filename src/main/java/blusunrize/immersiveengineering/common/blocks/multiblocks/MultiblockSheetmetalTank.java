...
public class MultiblockSheetmetalTank implements IMultiblock
{
	...
	{
		return new ItemStack[]{new ItemStack(IEContent.blockWoodenDecoration,4,1),new ItemStack(IEContent.blockMetalDecoration,37,BlockMetalDecoration.META_sheetMetal)};
	}
}