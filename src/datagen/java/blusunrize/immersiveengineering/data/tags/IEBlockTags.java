...
public class IEBlockTags extends BlockTagsProvider
{
	...
	private void registerGrindingDiskMineable()
	{
		...
		tag.addTag(IETags.copperBulbs);
		tag.addTag(IETags.copperGrates);
		tag.addTag(IETags.copperDoors);
		tag.addTag(IETags.copperTrapdoors);
		// vanilla blocks
		tag.add(Blocks.ANVIL, Blocks.CHIPPED_ANVIL, Blocks.DAMAGED_ANVIL);
		tag.add(Blocks.CHAIN, Blocks.IRON_BARS, Blocks.LANTERN, Blocks.SOUL_LANTERN, Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE, Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE,
				...
				Blocks.IRON_DOOR, Blocks.IRON_TRAPDOOR, Blocks.RAIL, Blocks.POWERED_RAIL, Blocks.ACTIVATOR_RAIL, Blocks.DETECTOR_RAIL);
		// scaffolding
		tag.addTag(IETags.scaffoldingSteel);
		tag.addTag(IETags.scaffoldingAlu);
