...
public class MultiblockDieselGenerator extends TemplateMultiblock
{
	...
	public boolean createStructure(World world, BlockPos pos, Direction side, PlayerEntity player)
	{
		...
		if(b)
		{
			BlockState state = IEContent.blockMetalMultiblock.getStateFromMeta(BlockTypes_MetalMultiblock.DIESEL_GENERATOR.getMeta());
