...
public class MultiblockSheetmetalTank extends TemplateMultiblock
{
	...
	public boolean createStructure(World world, BlockPos pos, Direction side, PlayerEntity player)
	{
		...
		BlockState state = IEContent.blockMetalMultiblock.getStateFromMeta(BlockTypes_MetalMultiblock.TANK.getMeta());
