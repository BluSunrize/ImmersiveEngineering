 ...
 */
 ...
 public class IEClientConfig
 {
	 ...
	 public final static BooleanValue disableBlueprintEngiWorkbench;
	 ...
	 static
	 {
		 ...
		 disableBlueprintEngiWorkbench = builder
				 .comment("Disables the rendering of blueprints when placed in engineers workbench.",
						 "May fix some shaders related issues")
				 .define("disableBlueprintEngiWorkbench", false);
