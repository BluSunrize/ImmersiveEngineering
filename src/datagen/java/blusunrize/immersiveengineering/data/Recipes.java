...
//			addStandardSmeltingBlastingRecipe(dust, ingot, metal.smeltingXP, out, "_from_dust"); //TODO: remove this, if 0 XP on dust is intentional. this bugs out because the alloys do not have metal.smeltingXP
	...
	private void recipesStoneDecorations(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.hempcrete), IEBlocks.toSlab.get(StoneDecoration.hempcrete), 2)
				.unlocks("has_hempcrete", has(StoneDecoration.hempcrete))
				.save(out, toRL("hempcrete_slab_from_hempcrete_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.hempcrete), StoneDecoration.hempcreteStairs)
				.unlocks("has_hempcrete", has(StoneDecoration.hempcrete))
				.save(out, toRL("hempcrete_stairs_from_hempcrete_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concrete), IEBlocks.toSlab.get(StoneDecoration.concrete), 2)
				.unlocks("has_concrete", has(StoneDecoration.concrete))
				.save(out, toRL("concrete_slab_from_concrete_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concrete), StoneDecoration.concreteStairs[0])
				.unlocks("has_concrete", has(StoneDecoration.concrete))
				.save(out, toRL("concrete_stairs_from_concrete_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concreteTile), IEBlocks.toSlab.get(StoneDecoration.concreteTile), 2)
				.unlocks("has_concrete", has(StoneDecoration.concrete))
				.save(out, toRL("concrete_tile_slab_from_concrete_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concreteTile), StoneDecoration.concreteStairs[1])
				.unlocks("has_concrete", has(StoneDecoration.concrete))
				.save(out, toRL("concrete_tile_stairs_from_concrete_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concreteLeaded), IEBlocks.toSlab.get(StoneDecoration.concreteLeaded), 2)
				.unlocks("has_concrete", has(StoneDecoration.concrete))
				.save(out, toRL("concrete_leaded_slab_from_concrete_leaded_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(StoneDecoration.concreteLeaded), StoneDecoration.concreteStairs[2])
				.unlocks("has_concrete", has(StoneDecoration.concrete))
	...
	private void recipesWoodenDecorations(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		FluidAwareShapedRecipeBuilder.builder(WoodenDecoration.treatedWood.get(TreatedWoodStyles.HORIZONTAL), 8)
				...
				.unlockedBy("has_creosote", has(IEContent.fluidCreosote.getBucket()))
	...
	private void recipesMetalDevices(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		ShapedRecipeBuilder.shaped(MetalDevices.barrel)
				...
				.define('s', IEBlocks.toSlab.get(IEBlocks.Metals.sheetmetal.get(EnumMetals.IRON)))
	...
	private void recipesWeapons(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		ShapedRecipeBuilder.shaped(BulletHandler.emptyShell.getItem(), 5)
				.pattern("prp")
				.pattern("prp")
				.pattern(" c ")
				.define('p', Items.PAPER)
				...
				.save(out, toRL(toPath(BulletHandler.emptyShell.getItem())));

		ShapedRecipeBuilder.shaped(BulletHandler.emptyCasing.getItem(), 5)
				.pattern("c c")
				.pattern("c c")
				.pattern(" c ")
				.define('c', IETags.getTagsFor(EnumMetals.COPPER).plate)
				.unlockedBy("has_coppper_ingot", has(IETags.getTagsFor(EnumMetals.COPPER).ingot))
				.save(out, toRL(toPath(BulletHandler.emptyCasing.getItem())));
	...
	private void recipesMisc(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		ShapedRecipeBuilder.shaped(Misc.cartWoodenCrate)
				.pattern("B")
				.pattern("C")
				.define('B', WoodenDevices.crate)
				.define('C', Items.MINECART)
				.unlockedBy("has_minecart", has(Items.MINECART))
				.save(out, toRL(toPath(Misc.cartWoodenCrate)));
		ShapedRecipeBuilder.shaped(Misc.cartReinforcedCrate)
				.pattern("B")
				.pattern("C")
				.define('B', WoodenDevices.reinforcedCrate)
				.define('C', Items.MINECART)
				.unlockedBy("has_minecart", has(Items.MINECART))
				.save(out, toRL(toPath(Misc.cartReinforcedCrate)));
		ShapedRecipeBuilder.shaped(Misc.cartWoodenBarrel)
				.pattern("B")
				.pattern("C")
				.define('B', WoodenDevices.woodenBarrel)
				.define('C', Items.MINECART)
				.unlockedBy("has_minecart", has(Items.MINECART))
				.save(out, toRL(toPath(Misc.cartWoodenBarrel)));
		ShapedRecipeBuilder.shaped(Misc.cartMetalBarrel)
				.pattern("B")
				.pattern("C")
				.define('B', MetalDevices.barrel)
				.define('C', Items.MINECART)
				.unlockedBy("has_minecart", has(Items.MINECART))
				.save(out, toRL(toPath(Misc.cartMetalBarrel)));
	}

	private void addArmor(Named<Item> input, Map<EquipmentSlot, Item> items, String name, Consumer<FinishedRecipe> out)
	{
		Item head = items.get(EquipmentSlot.HEAD);
		Item chest = items.get(EquipmentSlot.CHEST);
		Item legs = items.get(EquipmentSlot.LEGS);
		Item feet = items.get(EquipmentSlot.FEET);
	...
	private void addStairs(ItemLike block, ItemLike stairs, Consumer<FinishedRecipe> out)
	{
