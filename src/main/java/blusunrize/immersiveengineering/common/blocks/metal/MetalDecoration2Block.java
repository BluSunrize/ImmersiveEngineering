...
public class MetalDecoration2Block extends IETileProviderBlock<BlockTypes_MetalDecoration2> implements IPostBlock
{
	public MetalDecoration2Block()
	{
	...
	public TileEntity createBasicTE(World worldIn, BlockTypes_MetalDecoration2 type)
	{
		switch(type)
		{
			...
			case RAZOR_WIRE:
				return new RazorWireTileEntity();
			case TOOLBOX:
				return new ToolboxTileEntity();
			case STEEL_SLOPE:
			case ALU_SLOPE:
				return new StructuralArmTileEntity();
		}
		return null;
	}
