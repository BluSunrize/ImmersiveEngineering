 ...
 */
//<recipetype:immersiveengineering:refinery>.addRecipe(recipePath as string, fluidInput1 as MCTag<MCFluid>, amount1 as int, fluidInput2 as MCTag<MCFluid>, amount2 as int, energy as int, output as IFluidStack)
