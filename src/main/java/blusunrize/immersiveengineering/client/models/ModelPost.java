...
public class ModelPost extends ModelBase
{
	...
	public void render(boolean armLeft, boolean armRight)
	{
		this.Pole.render(.0625f);
		if(armRight)
			this.Arm_right.render(.0625f);
		if(armLeft)
			this.Arm_left.render(.0625f);
		this.Top_mid.render(.0625f);
		this.Base.render(.0625f);
	}
